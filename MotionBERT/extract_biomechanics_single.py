...
class CyclingBiomechanicsAnalyzer:
    ...
    def plot_joint_angles(self):
        ...
        fig.suptitle('Joint Angles Analysis', fontsize=16, y=0.98)
    ...
    def plot_angular_velocities(self):
        ...
        fig.suptitle('Angular Velocity Analysis', fontsize=16, y=0.98)
...
def main():
    ...
    try:
        ...
        npy_path = os.path.basename(args.input)
        filename_without_ext = os.path.splitext(npy_path)[0]
        output_dir = f"biomech_outputs_{filename_without_ext}"
